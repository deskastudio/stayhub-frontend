...
const AdminDataPembayaran: React.FC = () => {
  ...
  const data = [
    ...
    { idBayar: "000005", typeKamar: "Gold", noKamar: "105", jatuhTempo: "20/11/24", status: "Belum bayar", total: "Rp. 500.000" },
    { idBayar: "000006", typeKamar: "Silver", noKamar: "106", jatuhTempo: "20/11/24", status: "Lunas", total: "Rp. 500.000" },
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      {/* Card Payment */}
      <div className="mb-6">
        <CardPayment pendapatanBulanan="Pendapatan Bulanan" bulan="Januari" totalPendapatan="Rp. 20.000.000" penghuniBelumBayar={10} pembayaranBerhasil={10} />
      </div>
      ...
      <div className="overflow-x-auto mb-4">
        <PaymentTable data={currentItems} /> {/* Menampilkan data yang sudah difilter */}
      </div>

      {/* Container untuk jumlah dan pagination */}
      <div className="flex items-center mt-4">
        <p className="text-sm">
          Jumlah {indexOfFirstItem + 1}-{Math.min(indexOfLastItem, filteredData.length)} dari {filteredData.length}
        </p>
