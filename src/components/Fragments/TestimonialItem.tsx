      ...
      <table className="w-full border">
        <tbody>
          <tr className="border-b border-gray-300 bg-gray-200">
            ...
            <td className="pl-2 py-1 text-left">{testimonial.name}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <th className="font-bold py-2 px-3 align-top text-left">Type Kamar</th>
            <td className="pl-2 py-1 text-left">{testimonial.roomType}</td>
          </tr>
          <tr className="border-b border-gray-300 bg-gray-200">
            <th className="font-bold py-14 px-3 align-top text-left">No Kamar</th>
            <td className="pl-2 py-1 text-left">{testimonial.roomNumber}</td>
          </tr>
          <tr className="border-b border-gray-300">
            <th className="font-bold py-2 px-3 align-top text-left">Ulasan</th>
            <td className="pr-6 py-4 text-justify">{testimonial.review}</td>
          </tr>
          <tr className="bg-gray-200">
            <th className="font-bold py-14 px-3 align-top text-left ">Rating</th>
            <td className="pl-2 py-1 text-left text-3xl text-yellow-500">{"★".repeat(testimonial.rating)}</td>
          </tr>
        </tbody>
      </table>
