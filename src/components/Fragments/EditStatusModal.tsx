...
const EditStatusModal: React.FC<EditStatusModalProps> = ({ ajuan, onClose, onStatusUpdate }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-96">
        <div className="flex justify-between items-center relative">
          ...
          <button className="absolute -top-2 -right-3 text-gray-500 hover:text-gray-800 text-3xl mr-2" onClick={onClose}>
            &times;
          </button>
        </div>
        <div className="mt-4">
          ...
          <select id="status" value={status} onChange={(e) => setStatus(e.target.value)} className="mt-1 block w-full p-2 border rounded-md">
